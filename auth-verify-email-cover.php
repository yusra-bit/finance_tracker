...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Verify Email')); ?>
    ...
    <div class="mb-0 border-none lg:w-[500px] card bg-white/70 shadow-none dark:bg-zink-500/70">
        <div class="!px-10 !py-12 card-body">
            ...
            <div class="mt-8 text-center">
                ...
                <p class="mb-4 text-slate-500 dark:text-zink-200">Did you not receive an email? Please <a href="index.php" class="text-custom-500">try again</a></p>
                <a href="index.php" class="px-2 py-1.5 text-xs text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100">Skip Now</a>
            </div>
