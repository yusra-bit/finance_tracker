...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Two Steps')); ?>
        ...
        <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
            <div class="!px-10 !py-12 card-body">
                ...
                <div class="mt-8 text-center">
                    ...
                    <p class="mb-8 text-slate-500 dark:text-zink-200">Please enter the <b class="font-medium">code </b> sent to <b class="font-medium">your email</b></p>
                </div>


                <form method="POST" action="vertification-code.php">
                    <div class="">
                        <div>
                            <label for="digit1-input" class="hidden"> Vertification Code</label>
                            <input type="hidden" name="user_id" value="<?php echo ($_GET['id']) ? $_GET['id'] : ''; ?>">

                            <input type="text" name="verification_code" class="text-lg text-center form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" required placeholder="0 0 0 0 0 0" id="digit1-input">
                        </div>
                    </div>
                    <div class="mt-10">
