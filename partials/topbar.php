                ...
                <div class="flex gap-3 ms-auto">
                    ...
                    <div class="relative flex items-center dropdown h-header">
                        ...
                        <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600" aria-labelledby="dropdownMenuButton">
                            <h6 class="mb-2 text-sm font-normal text-slate-500 dark:text-zink-300">Welcome to Finance Tracker</h6>
                            <a href="#!" class="flex gap-3 mb-3">
                                ...
                                <div>
                                    <h6 class="mb-1 text-15"> <?php echo $_SESSION['email']; ?></h6>
                                </div>
                            </a>
                            <ul>
                                ...
                                <form action="logout.php" method="post">   
                                    <input  type="submit" value='Logout' class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500">
                                 </form>
                                </li>
                            </ul>
                        </div>
